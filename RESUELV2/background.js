        ...
        case 'SAVE_CLIPBOARD_ITEM': {
          ...
          (async () => {
            try {
              ...
              if (clipboardAI && text.length > 10 && type !== 'color') {
...
- Use __underline__ to underline a phrase.
- Use ==highlight== to highlight key terms.
- Use `inline code` for code fragments.
- Use emojis directly in strings (e.g., "✅", "📌").

Lists and tables:
- Use "sections[].bullets" for lists.
- Use "tables" for tables.
- Use "charts" for simple charts.
